    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="w-[600px] p-4 rounded-lg bg-white relative max-h-[80vh] overflow-y-auto">
            <button onClick={closeSitePolicy} className="absolute top-2 right-2 text-gray-500">
              <FaTimes />
            </button>
            <div className="text-center text-lg underline">Site Policy</div>
            <div className="p-2">
              ...
              <ol>
                ...
                <li>
                  ...
                  <p>
                    If you have any questions or concerns about this Site Policy, please contact us via contact form.
                  </p>
                </li>
              </ol>
            </div>
